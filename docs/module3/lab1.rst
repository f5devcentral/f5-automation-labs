...
To test your setup with the ``hello_world`` container, you just need to run the following command: **docker run hello-world**
...
.. NOTE:: The *--rm* option will delete the container as soon as it stops running. 
	...
	If you want to remove the hello-world container, you can run the command **sudo docker rmi hello-world**
